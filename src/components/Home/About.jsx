  ...
  return (
    <div className="container-about">
      ...
      <div className="about-content">
        ...
        <p>
          Face Insight AI is committed to protecting your privacy. We do not
          store any images that you upload to the app, and we do not share any
          of your personal information with third parties. All images are
          deleted from our servers immediately after analysis is complete.
        </p>
